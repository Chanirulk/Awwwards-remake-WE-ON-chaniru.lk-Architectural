!function() {
        ...
        g = function() {
            ...
            return i(e, [{
                ...
                value: function(t, e) {
                    ...
                    "call" === t && (this.hasCallEventSet = !0, this.detectElements(!0))
                }
            }, {
                key: "unsetEvents",
                value: function(t, e) {
    ...
    function V(t) {
        !function(t) {
            ...
            if (0 === e.length)
                for (var i in t)
                    B.call(t, i) && "function" == typeof t[i] && "[object Function]" == j.call(t[i]) && e.push(i);
    ...
    V.prototype._bind = function() {
        ...
        M.hasPointer && M.hasTouchWin && (this.bodyTouchAction = document.body.style.msTouchAction, document.body.style.msTouchAction = "none", this.el.addEventListener("MSPointerDown", this._onTouchStart, !0), this.el.addEventListener("MSPointerMove", this._onTouchMove, !0)),
    ...
    V.prototype._unbind = function() {
        ...
        M.hasPointer && M.hasTouchWin && (document.body.style.msTouchAction = this.bodyTouchAction, this.el.removeEventListener("MSPointerDown", this._onTouchStart, !0), this.el.removeEventListener("MSPointerMove", this._onTouchMove, !0)),
    ...
    !function() {
        ...
        setTimeout((function() {
            ...
            e.on("scroll", (function(t) {
                ...
                e.el.style.backgroundColor = "hsl("(n, ""),
                i.forEach((function(t) {
                    t.el.style.backgroundColor = "hsl("(n, "")
                })),
                s.forEach((function(t) {
                    t.el.style.color = "hsl(".concat(n, "")
                })),
                document.documentElement.setAttribute("", t.direction)
            })),
